      ...
      <div className="cool-flex-container pt-10">
        <div className="lg:max-w-[500px] xl:max-w-[600px] overflow-hidden lg:order-2">
          ...
          <div className="text-2xl leading-9 text-left mb-7 overflow-hidden flex justify-between flex-col sm:flex-row">
            <div className="float-left mr-4"><div><b>Full Stack Developer</b></div></div>
          ...
          <div className="text-2xl text-left pb-4 mt-4 mb-10 lg:mb-0">
            ...
            CarGenie AI is an app that provides car recommendations to users. I designed and implemented the data
            pipeline necessary to integrate listings from two new partners after I joined. I improved the efficiency of
            the recommendation algorithm, reducing the wait time for each recommendation from approximately 8 seconds to
            less than 1 second. During my time working with CarGenie, online quiz completions increased from
            approximately 100 per day to 450 per day.
          </div>
        </div>
